...
function AnchBtn() {
    return <button className={styles.btnSeeCharts}><span><svg data-slot="icon" fill="none" stroke-width="1" stroke="currentColor" width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
